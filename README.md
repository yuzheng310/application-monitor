...
| 找到某家公司 | 左侧目录点击跳转，高亮当前公司；窄屏目录移到顶部 |
...
当前源码提供 **20 个**校招或应聘记录入口：

百度 · MiniMax · 得物 · 快手 · 滴滴 · 美团 · 京东 · 蚂蚁集团 · 阿里巴巴 · 小红书 · 携程 · 米哈游 · 库洛游戏 · 商汤 · 同花顺 · 网易游戏 · 科大讯飞 · 小米 · 小鹏汽车 · Momenta。

**版本差异：**v1.1.0 安装包已包含并行查询与错误反馈；小鹏汽车、Momenta、更新优先排序、公司目录及本次视觉更新仍属于后续源码更新。现有用户配置不会被新版示例配置自动覆盖，新增公司需合并到自己的 `sites.json`，可让 AI 按指南完成。
